...
#ifndef SHOWLOG
#define SHOWLOG() \
    UE_LOG(LogUE_ReNe, Log, TEXT("[%s:%d] %s"), \
...
#define SHOWLOGF(Format, ...) \
    UE_LOG(LogUE_ReNe, Log, TEXT("[%s:%d] %s | " Format), \
        ANSI_TO_TCHAR(__FILE__), \
        __LINE__, \
        ANSI_TO_TCHAR(__FUNCTION__), \
        ##__VA_ARGS__)
...
#ifndef SHOWWARN
#define SHOWWARN() \
    UE_LOG(LogUE_ReNe, Warning, TEXT("[%s:%d] %s"), \
        ANSI_TO_TCHAR(__FILE__), \
        __LINE__, \
        ANSI_TO_TCHAR(__FUNCTION__))
#endif
...
#define SHOWWARNF(Format, ...) \
    UE_LOG(LogUE_ReNe, Warning, TEXT("[%s:%d] %s | " Format), \
        ANSI_TO_TCHAR(__FILE__), \
        __LINE__, \
        ANSI_TO_TCHAR(__FUNCTION__), \
        ##__VA_ARGS__)
...
#ifndef SHOWERROR
#define SHOWERROR() \
    UE_LOG(LogUE_ReNe, Error, TEXT("[%s:%d] %s"), \
        ANSI_TO_TCHAR(__FILE__), \
        __LINE__, \
        ANSI_TO_TCHAR(__FUNCTION__))
#endif
...
#define SHOWERRORF(Format, ...) \
    UE_LOG(LogUE_ReNe, Error, TEXT("[%s:%d] %s | " Format), \
        ANSI_TO_TCHAR(__FILE__), \
        __LINE__, \
        ANSI_TO_TCHAR(__FUNCTION__), \
        ##__VA_ARGS__)
